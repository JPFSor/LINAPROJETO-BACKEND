...
VALUES (1, 'Omelete com Legumes', 10, 220,
       ...
       (9, 'Mix de Castanhas', 2, 180, '1. Separe a porção. 2. Consuma diretamente.',
       ...
       (17, 'Iogurte com Granola', 3, 190, '1. Coloque o iogurte. 2. Adicione a granola. 3. Misture. 4. Sirva.',
...
VALUES (1, 'Dra. Mariana Costa', 'mariana.costa@nutricao.com', 'CRN-3/12345', '(15) 99876-5432',
        'Intolerâncias Alimentares', 5.0, 150, null, 100),
       (2, 'Dr. Rafael Mendes', 'rafael.mendes@nutricao.com', 'CRN-3/22222', '(11) 98888-1111', 'Nutrição Esportiva',
        4.8, 230, null, 101),
       (3, 'Dra. Camila Rocha', 'camila.rocha@nutricao.com', 'CRN-6/33333', '(31) 97777-2222', 'Veganos e Vegetarianos',
        4.9, 180, null, 102),
       (4, 'Dra. Fernanda Lima', 'fernanda.lima@nutricao.com', 'CRN-3/44444', '(15) 96666-3333', 'Diabetes e Obesidade',
        4.7, 120, null, 100),
       (5, 'Dr. Lucas Alves', 'lucas.alves@nutricao.com', 'CRN-3/55555', '(15) 95555-4444', 'Restrições Alimentares',
        4.6, 90, null, 100);


-- ── RESETAR AUTO-INCREMENT DO H2 ──────────────
ALTER TABLE ingrediente
    ALTER COLUMN id RESTART WITH 27;
